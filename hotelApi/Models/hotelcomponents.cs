...
namespace hotelApi.Models
{
    ...
    public class hotelcomponent : DbContext
    {
       public  DbSet<hotelcomponents> hotel { get; set; }
        ...
        {
            const string strcon= "Data Source=W-674PY03-1;Initial Catalog=karthik;Persist Security Info=True;User ID=sa;Password=Password@12345;TrustServerCertificate=True" ;
